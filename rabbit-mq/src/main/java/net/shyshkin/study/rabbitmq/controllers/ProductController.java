package net.shyshkin.study.rabbitmq.controllers;

import net.shyshkin.study.rabbitmq.commands.ProductForm;
import net.shyshkin.study.rabbitmq.converters.ProductToProductForm;
import net.shyshkin.study.rabbitmq.domain.Product;
import net.shyshkin.study.rabbitmq.services.ProductService;
